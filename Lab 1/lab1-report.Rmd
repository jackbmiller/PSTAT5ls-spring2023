...
1. Make the text below that says "Tips and Tricks for R Markdown" \textcolor{blue}{bold}.
2. Make the text below that says "Knit and knit often" \textcolor{blue}{italic}.
3. Make the text below that says "Make sure your chunk syntax is correct" \textcolor{blue}{italic}.
4. Make the text below that says "Be persistent!" \textcolor{blue}{bold}.
:::
...
:::{.question}
In the chunk below, import ("read in") the data in `a2trees_clean.csv` and call it `a2trees`. Hint: We read in the penguins data in the lab tutorial.
:::
...
The quantitative variables in the data are: 
